 ...
 */
@Slf4j
@ControllerAdvice(basePackages = {"cloud.xuxiaowei.cloud", "org.springframework.security.oauth2.provider.endpoint", "org.springframework.security.oauth2.provider.request"})
...
//    }
    ...
    public Response<?> sqlIntegrityConstraintViolationException(SQLIntegrityConstraintViolationException exception, HttpServletRequest request) {
    ...
    public Response<?> missingServletRequestParameterException(MissingServletRequestParameterException exception, HttpServletRequest request) {
...
//    public Response<?> insufficientScopeException(InsufficientScopeException exception, HttpServletRequest request) {
//
...
//    }
    ...
    public Response<?> httpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException exception, HttpServletRequest request) {
    ...
    public Response<?> httpMessageNotReadableException(HttpMessageNotReadableException exception, HttpServletRequest request) {
