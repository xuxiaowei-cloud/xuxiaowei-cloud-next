...
/**
 * 支持 {@link EnableMethodSecurity}、{@link PreAuthorize}
 *
 * @author xuxiaowei
 * @since 0.0.1
 */
...
public class JwtAuthenticationConverterConfiguration {
	...
	/**
	 * 支持 {@link EnableMethodSecurity}、{@link PreAuthorize} 的 {@link Bean}
	 * @return 支持 {@link EnableMethodSecurity}、{@link PreAuthorize}
	 * @see <a href=
