...
CREATE TABLE `authorities`  (
  ...
  CONSTRAINT `authorities_ibfk_1` FOREIGN KEY (`authority`) REFERENCES `authority` (`authority`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `authorities_ibfk_2` FOREIGN KEY (`username`) REFERENCES `users` (`username`) ON DELETE RESTRICT ON UPDATE RESTRICT
