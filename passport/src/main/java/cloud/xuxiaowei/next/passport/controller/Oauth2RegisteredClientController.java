...
public class Oauth2RegisteredClientController {
    ...
    @RequestMapping("/page")
    public Response<?> page(HttpServletRequest request, HttpServletResponse response, @Valid @RequestBody Oauth2RegisteredClientPageBo oauth2RegisteredClientPageBo) {

        IPage<Oauth2RegisteredClientVo> page = oauth2RegisteredClientService.pageByOauth2RegisteredClientPageBo(oauth2RegisteredClientPageBo);
    ...
    public Response<?> removeById(HttpServletRequest request, HttpServletResponse response, @PathVariable("id") String id) {
    ...
    public Response<?> removeByIds(HttpServletRequest request, HttpServletResponse response, @RequestBody List<String> ids) {
    ...
    public Response<?> getById(HttpServletRequest request, HttpServletResponse response, @PathVariable("id") String id) {
    ...
    @RequestMapping("/save")
    public Response<?> save(HttpServletRequest request, HttpServletResponse response, @Valid @RequestBody Oauth2RegisteredClientSaveBo oauth2RegisteredClientSaveBo) {
    ...
    public Response<?> updateById(HttpServletRequest request, HttpServletResponse response, @Valid @RequestBody Oauth2RegisteredClientUpdateBo oauth2RegisteredClientUpdateBo) {

        boolean update = oauth2RegisteredClientService.updateByOauth2RegisteredClientUpdateBo(oauth2RegisteredClientUpdateBo);
