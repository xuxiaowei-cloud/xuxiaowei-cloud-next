...
public class Oauth2AuthorizationController {
    ...
    @RequestMapping("/page")
    public Response<?> page(HttpServletRequest request, HttpServletResponse response, @Valid @RequestBody Oauth2AuthorizationPageBo oauth2AuthorizationPageBo) {

        IPage<Oauth2AuthorizationVo> page = oauth2AuthorizationService.pageByOauth2AuthorizationPageBo(oauth2AuthorizationPageBo);
