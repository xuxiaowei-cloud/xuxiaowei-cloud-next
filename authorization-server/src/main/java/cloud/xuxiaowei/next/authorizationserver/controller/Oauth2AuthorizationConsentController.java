...
public class Oauth2AuthorizationConsentController {
    ...
    @Autowired
    public void setOauth2AuthorizationConsentService(IOauth2AuthorizationConsentService oauth2AuthorizationConsentService) {
    ...
    @RequestMapping("/page")
    public Response<?> page(HttpServletRequest request, HttpServletResponse response, @Valid @RequestBody Oauth2AuthorizationConsentPageBo oauth2AuthorizationConsentPageBo) {

        IPage<Oauth2AuthorizationConsent> page = oauth2AuthorizationConsentService.pageByOauth2AuthorizationConsentPageBo(oauth2AuthorizationConsentPageBo);
    ...
    public Response<?> removeById(HttpServletRequest request, HttpServletResponse response, @RequestBody Oauth2AuthorizationConsentPrimaryKey oauth2AuthorizationConsentPrimaryKey) {

        boolean removeByPrimaryKey = oauth2AuthorizationConsentService.removeByPrimaryKey(oauth2AuthorizationConsentPrimaryKey);
    ...
    public Response<?> removeByIds(HttpServletRequest request, HttpServletResponse response, @RequestBody List<Oauth2AuthorizationConsentPrimaryKey> oauth2AuthorizationConsentPrimaryKeys) {

        AssertUtils.sizeNonNull(oauth2AuthorizationConsentPrimaryKeys, 1, 50, "非法数据长度");

        boolean removeByIds = oauth2AuthorizationConsentService.removeByPrimaryKeys(oauth2AuthorizationConsentPrimaryKeys);
